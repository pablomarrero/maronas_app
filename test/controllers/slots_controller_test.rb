...
class SlotsControllerTest < ActionController::TestCase
  ...
  test "should create slot" do
    assert_difference('Slot.count') do
      post :create, slot: { address: @slot.address, description: @slot.description, name: @slot.name, opentimes: @slot.opentimes }
    end
  ...
  test "should update slot" do
    patch :update, id: @slot, slot: { address: @slot.address, description: @slot.description, name: @slot.name, opentimes: @slot.opentimes }
    assert_redirected_to slot_path(assigns(:slot))
  end
